...
ActiveRecord::Schema.define(version: 20150705231910) do
  ...
  add_index "prices", ["state_id", "created_at"], name: "index_prices_on_state_id_and_created_at", unique: true, using: :btree
